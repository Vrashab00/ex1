...
exports.telemetryService = exports.MockCloudTelemetryAdapter = void 0;
...
class MockCloudTelemetryAdapter {
    instances;
    constructor() {
    ...
    setInstanceFeedback(instanceId, feedback) {
...
exports.MockCloudTelemetryAdapter = MockCloudTelemetryAdapter;
exports.telemetryService = new MockCloudTelemetryAdapter();
